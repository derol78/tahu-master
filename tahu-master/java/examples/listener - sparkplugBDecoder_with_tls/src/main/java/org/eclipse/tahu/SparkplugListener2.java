...
public class SparkplugListener2 implements MqttCallbackExtended {

	// Configuration
	private String serverUrl = "tcp://localhost:1883";
	private String clientId = "SparkplugBListenerEdgeNode_1";
	private String username = "test";
	private String password = "test";
	private MqttClient client;

	public static void main(String[] args) {
		SparkplugListener2 listener = new SparkplugListener2();
		listener.run();
	}
